                           ...
                           GClosure *closure)
{
  ...
  binding = (ExoBinding *) (gpointer) (((gchar *) blink) - G_STRUCT_OFFSET (ExoBinding, blink));
                                          ...
                                          GClosure *closure)
{
  ...
  binding = (ExoMutualBinding *) (gpointer) (((gchar *) blink) - G_STRUCT_OFFSET (ExoMutualBinding, direct));
                                          ...
                                          GClosure *closure)
{
  ...
  binding = (ExoMutualBinding *) (gpointer) (((gchar *) blink) - G_STRUCT_OFFSET (ExoMutualBinding, reverse));
  binding->direct.dst_object = NULL;
