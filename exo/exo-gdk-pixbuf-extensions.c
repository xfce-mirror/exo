 ...
 * Since: 0.3.1.3
 *
 * Deprecated: 4.21.0: Use xfce_gdk_pixbuf_colorize() instead.
 **/
GdkPixbuf*
                         ...
                         const GdkColor  *color)
{
  ...
  if (G_LIKELY (has_alpha && dst_row_stride == width * 4 && src_row_stride == width * 4 && (width * height) % 2 == 0))
    {
      __m64 *pixdst = (__m64 *) (gpointer) gdk_pixbuf_get_pixels (dst);
      __m64 *pixsrc = (__m64 *) (gpointer) gdk_pixbuf_get_pixels (source);
 ...
 * Since: 0.3.1.3
 *
 * Deprecated: 4.21.0: Use xfce_gdk_pixbuf_spotlight() instead.
 **/
GdkPixbuf*
